...
def main():
    ...
    parser.add_argument(
        ...
        default="/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023/IDEA_worse_HCalEReso_CMS/",
    )
    parser.add_argument(
        "--outdir",
        help="path output directory",
        default="/eos/experiment/fcc/ee/jet_flavour_tagging/winter2023/fastsim_2mio_total_SaraTagging/IDEA_HCALreso-CMS/evaluation/",
    )
