...
def main():
    ...
    parser.add_argument(
        ...
        default="/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023_training/IDEA_SiTracking/",
    )
    parser.add_argument(
        "--outdir",
        help="path output directory",
        default="/eos/experiment/fcc/ee/jet_flavour_tagging/winter2023/fastsim_2mio_total_SaraTagging/CLD/evaluation/",
    )
    ...
    for f in flavors:
        ...
        if opt == "2" or opt == "3":
            ...
            # use 1.9 mio events per file for training, 100k for evaluation
            nevents = 50000
            if test:
                if nevents>100:
                    nevents = 100
            ...
            for i in range(ncpus):
                ...
                cmd_stage2 = "python examples/FCCee/weaver/stage2.py {} {} {} {}".format(
                    stage1_files[f], stage2_files[i], nstart + 950000, nend + 950000 # add nevents to NOT get the first million events but the second million events to have different data than the trainings data to evaluate the network on
                )
