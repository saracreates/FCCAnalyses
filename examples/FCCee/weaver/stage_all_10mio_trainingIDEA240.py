...
def main():
    ...
    parser.add_argument(
        ...
        default="/eos/experiment/fcc/ee/jet_flavour_tagging/winter2023/fastsim_2mio_total_SaraTagging/IDEA/training_10M/",
    )
    ...
    for f in flavors:
        ...
        if opt == "2" or opt == "3":
            ...
            # use 10 mio events per file for training
            nevents = 5000000
            if test:
                if nevents>100:
                    nevents = 100
