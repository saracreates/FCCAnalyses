...
def main():
    ...
    parser.add_argument(
        ...
        default="/eos/experiment/fcc/ee/jet_flavour_tagging/winter2023/samples_v7/evaluation_7flavors_100k",
    )

    parser.add_argument(
        "--Hflavor",
        help="which flavor to run the script on, options: 'uu', 'dd', 'bb', 'cc', 'ss', 'gg', 'tautau' ",
        default="bb",
    )
    ...
    for f in flavors:
        ...
        if opt == "2" or opt == "3":
            ...
            # use 1 mio events per file for training 
            nevents = 50000
            if test:
                if nevents>100:
                    nevents = 100
            ...
            for i in range(ncpus):
                ...
                cmd_stage2 = "python examples/FCCee/weaver/stage2.py {} {} {} {}".format(
                    stage1_files[f], stage2_files[i], nstart + 500000, nend + 500000 # add nevents to NOT get the first million events but the second million events to have different data than the trainings data to evaluate the network on
                )
